...
describe('TypedMessage', () => {
  ...
  describe('add', () => {
    ...
    it('pushes the values to our args array', () => {
      expect(typedMessage.args).to.deep.equal([
        'Hello World',
        121123,
        123.123456789,
        true,
  ...
  describe('unpack', () => {
    ...
    beforeEach(() => {
      ...
      const data = new Uint8Array([
        47, 115, 111, 109, 101, 47, 97, 100, 100, 114, 0, 0, 44, 100, 115, 105,
        0, 0, 0, 0, 64, 94, 199, 230, 183, 77, 206, 89, 116, 101, 115, 116, 0,
        0, 0, 0, 0, 0, 0, 0,
      ])
...
describe('Message', () => {
  ...
  describe('unpack', () => {
    ...
    beforeEach(() => {
      ...
      const data = new Uint8Array([
        47, 116, 101, 115, 116, 47, 112, 97, 116, 104, 0, 0, 44, 105, 0, 0, 0,
        0, 2, 141,
      ])
      const dataView = new DataView(data.buffer, 0)
